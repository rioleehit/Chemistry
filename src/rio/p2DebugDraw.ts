class p2DebugDraw{
    ...
    //     this.sprite.graphics.moveTo(start[0] * this.factor, this.winHeight - start[1]*this.factor);
    //     this.sprite.graphics.lineTo(end[0] * this.factor, this.winHeight - end[1]*this.factor);
    // }
    ...
    //     this.sprite.graphics.drawCircle(pos[0] * this.factor, this.winHeight - pos[1]*this.factor, radius*this.factor);
    ...
    //     this.sprite.graphics.moveTo(worldPoint[0] * this.factor, this.winHeight - worldPoint[1]*this.factor);
    //     for (var i: number = 1; i <= l; i++) {
    //         worldPoint = vertices[i % l];
    //         this.sprite.graphics.lineTo(worldPoint[0]*this.factor, this.winHeight - worldPoint[1]*this.factor);
    //     }
    //     this.sprite.graphics.endFill();
    // }
